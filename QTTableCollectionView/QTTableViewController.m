...
@property (nonatomic, strong) NSMutableDictionary *contentOffsetDictionaryOfBoards;
@property (nonatomic, strong) NSMutableDictionary *contentOffsetDictionaryOfUsers;
// DataSource / 数据源。
...
- (void)viewDidLoad {
    ...
    self.contentOffsetDictionaryOfExplores = [NSMutableDictionary dictionary];
    self.contentOffsetDictionaryOfBoards = [NSMutableDictionary dictionary];
    self.contentOffsetDictionaryOfUsers = [NSMutableDictionary dictionary];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0) {
        // 此处，TableViewCell（UICollectionViewCell）的高度固定。
        return 132;
    } else if (indexPath.section == 1) {
        return 190;
    } else if (indexPath.section == 2) {
